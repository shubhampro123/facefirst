...
class Test_event_search_filter_combination(Base_Class):
    ...
    def setup_method(self):
        try:
            ...
            print("\nException in Test_event_search_filter_combination/setup_method: ", ex)

    @pytest.mark.p1
    def test_TC_ESFC_01(self):
        self.logger.info("Event Search Filter Combination = test_TC_ESFC_01 execution started..")
        if Event_search_filter_combinations_POM().event_search_with_no_filter_combination():
            assert True
        else:
    ...
    def test_TC_ESFC_02(self):
        ...
        if Event_search_filter_combinations_POM().event_search_with_tag_filter_combination():
            assert True
        else:
    ...
    def test_TC_ESFC_03(self):
        ...
        if Event_search_filter_combinations_POM().event_search_with_org_Hierarchy_filter_combination():
            assert True
        else:
    ...
    def test_TC_ESFC_04(self):
        ...
        if Event_search_filter_combinations_POM().event_search_with_tag_and_org_hierarchy_filter_combination():
            assert True
        else:
    ...
    def test_TC_ESFC_05(self):
        ...
        if Event_search_filter_combinations_POM().event_search_with_enrollmentGroup_filter_combination():
            assert True
        else:
    ...
    def test_TC_ESFC_06(self):
        ...
        if Event_search_filter_combinations_POM().event_search_with_enrollmentGroup_and_tag_filter_combination():
            assert True
        else:
    ...
    def test_TC_ESFC_07(self):
        ...
        if Event_search_filter_combinations_POM().event_search_with_enrollmentGroup_org_hierarchy_filter_combination():
            assert True
        else:
    ...
    def test_TC_ESFC_08(self):
        ...
        if Event_search_filter_combinations_POM().\
    ...
    def test_TC_ESFC_09(self):
        ...
        if Event_search_filter_combinations_POM().event_search_with_dateTimeRange_filter_combination():
            assert True
        else:
    ...
    def test_TC_ESFC_010(self):
        ...
        if Event_search_filter_combinations_POM().event_search_with_DateTimeRange_and_Tag_filter_combination():
            assert True
        else:
