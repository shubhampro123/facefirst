...
from All_POM_Package.Enrollments_Module.Enrollments_Filter_combination_POM import Enrollments_Filter_combination_pom
from All_Test_Cases_Package.conftest import Base_Class


class Test_enrollments_search_filter_combination(Base_Class):
    user_list = None
    results = list()
    ...
    def test_TC_EFC_001(self):
        if Enrollments_Filter_combination_pom().enrollments_search_with_no_filter_criteria():
            ...
            self.d.save_screenshot(f"{self.screenshots_path}\\test_TC_EFC_001.png")
            assert False
    ...
    def test_TC_EFC_002(self):
        if Enrollments_Filter_combination_pom().enrollments_search_with_sort_by_case_subject_criteria():
            ...
            self.d.save_screenshot(f"{self.screenshots_path}\\test_TC_EFC_002.png")
            assert False
    ...
    def test_TC_EFC_003(self):
        if Enrollments_Filter_combination_pom().enrollments_search_with_sort_by_location_store_criteria():
            ...
            self.d.save_screenshot(f"{self.screenshots_path}\\test_TC_EFC_003.png")
            assert False
    ...
    def test_TC_EFC_004(self):
        if Enrollments_Filter_combination_pom().enrollments_search_with_Sort_by_Enrolled_On_criteria():
            ...
            self.d.save_screenshot(f"{self.screenshots_path}\\test_TC_EFC_004.png")
            assert False
    ...
    def test_TC_EFC_005(self):
        if Enrollments_Filter_combination_pom().enrollments_search_with_expiration_Date_Range_criteria():
            ...
            self.d.save_screenshot(f"{self.screenshots_path}\\test_TC_EFC_005.png")
            assert False

    @pytest.mark.p1
    def test_TC_EFC_006(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_expiration_Date_Range_and_sort_by_case_subject_criteria():
            assert True
        else:
            self.d.save_screenshot(f"{self.screenshots_path}\\test_TC_EFC_006.png")
            assert False

    @pytest.mark.p1
    def test_TC_EFC_007(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_expiration_date_range_and_sort_by_Location_store_criteria():
            assert True
        else:
            self.d.save_screenshot(f"{self.screenshots_path}\\test_TC_EFC_007.png")
            assert False

    @pytest.mark.p1
    def test_TC_EFC_008(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_expiration_date_range_and_sort_by_enrolled_On_criteria():
            assert True
        else:
            self.d.save_screenshot(f"{self.screenshots_path}\\test_TC_EFC_008.png")
            assert False

    @pytest.mark.p1
    def test_TC_EFC_009(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_enrollment_Date_Range_criteria():
            assert True
        else:
            self.d.save_screenshot(f"{self.screenshots_path}\\test_TC_EFC_009.png")
            assert False

    @pytest.mark.p1
    def test_TC_EFC_010(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_enrollment_Date_Range_and_Sort_by_Case_Subject_criteria():
            assert True
        else:
            self.d.save_screenshot(f"{self.screenshots_path}\\test_TC_EFC_010.png")
            assert False

    @pytest.mark.p1
    def test_TC_EFC_011(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_enrollment_Date_Range_and_Sort_by_Location_Store_criteria():
            assert True
        else:
            self.d.save_screenshot(f"{self.screenshots_path}\\test_TC_EFC_011.png")
            assert False

    @pytest.mark.p1
    def test_TC_EFC_012(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_Enrollment_Date_Range_and_Sort_by_enrolledOn_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_013(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_Enrollment_Date_Range_and_Expiration_Date_Range_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_014(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_Enrollment_Date_Range_Expiration_Date_Range_and_Sort_by_Case_Subject_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_015(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_Enrollment_Date_Range_Expiration_Date_Range_and_Sort_by_Location_Store_criteria(
        ):
            assert True
        else:
    ...
    def test_TC_EFC_016(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_Enrollment_Date_Range_Expiration_Date_Range_and_Sort_by_EnrolledOn_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_030(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_exact_text_enrollment_expiration_date_range_and_sort_by_case_subject_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_031(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_exact_text_enrollment_expiration_date_range_and_sort_by_location_store_criteria(
    ...
    def test_TC_EFC_032(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_exact_text_enrollment_expiration_date_range_and_sort_by_enrolled_on_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_033(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_034(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_and_sort_by_case_subject_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_035(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_and_sort_by_location_store_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_036(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_and_sort_by_enrolled_on_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_037(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_and_expiration_date_range_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_038(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_expiration_date_range_and_sort_by_case_subject_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_039(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_expiration_date_range_and_sort_by_location_store_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_040(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_expiration_date_range_and_sort_by_enrolled_on_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_041(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_and_enrollment_date_range_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_042(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_enrollment_date_range_and_sort_by_case_subject_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_043(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_enrollment_date_range_and_sort_by_location_store_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_044(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_enrollment_date_range_and_sort_by_enrolled_on_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_045(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_enrollment_date_and_expiration_date_range_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_046(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_enrollment_expiration_date_range_sort_by_case_subject_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_063(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_exact_text_enrollment_expiration_date_range_sort_store_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_064(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_case_subject_exact_text_enrollment_expiration_date_range_sort_enrolled_criteria(
    ...
    def test_TC_EFC_074(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_location_store_enrollment_date_range_and_sort_by_case_subject_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_075(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_location_store_enrollment_date_range_and_sort_by_location_store_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_076(self):
        if Enrollments_Filter_combination_pom() \
                .enrollment_search_with_location_store_enrollment_date_range_and_sort_by_enrolled_on_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_093(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_location_store_exact_text_search_enrollment_date_range_and_expiration_date_range_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_102(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_location_store_case_subject_expiration_date_range_sort_by_case_subject_criteria(
        ):
            assert True
        else:
    ...
    def test_TC_EFC_105(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_location_store_case_subject_Enrollment_date_range_criteria_criteria():
            assert True
        else:
    ...
    def test_TC_EFC_106(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_location_store_case_subject_Enrollment_date_range_sort_by_case_subject_criteria(
        ):
            assert True
        else:
    ...
    def test_TC_EFC_107(self):
        if Enrollments_Filter_combination_pom(). \
            enrollments_search_with_location_store_case_subject_Enrollment_date_range_sort_by_location_store_criteria(
        ):
            assert True
        else:
    ...
    def test_TC_EFC_108(self):
        if Enrollments_Filter_combination_pom(). \
            enrollments_search_with_location_store_case_subject_Enrollment_date_range_sort_by_enrolledOn_criteria(
        ):
            assert True
        else:
    ...
    def test_TC_EFC_109(self):
        if Enrollments_Filter_combination_pom(). \
            enrollments_search_with_location_store_case_subject_EnrollmentDateRange_expiration_date_range_criteria(
        ):
            assert True
        else:
    ...
    def test_TC_EFC_110(self):
        if Enrollments_Filter_combination_pom(). \
            enrollments_search_with_location_store_case_subject_EnrollmentDateRange_expiration_date_range_sort_by_case_subject_criteria(
        ):
            assert True
        else:
    ...
    def test_TC_EFC_111(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_location_store_case_subject_EnrollmentDateRange_expiration_date_range_sort_by_location_store_criteria(
        ):
            assert True
        else:
    ...
    def test_TC_EFC_112(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_location_store_case_subject_EnrollmentDateRange_expiration_date_range_sort_by_enrolledOn_criteria(
        ):
            assert True
        else:
    ...
    def test_TC_EFC_113(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_location_store_case_subject_exact_text_search_criteria(
        ):
            assert True
        else:
    ...
    def test_TC_EFC_114(self):
        if Enrollments_Filter_combination_pom(). \
                enrollments_search_with_location_store_case_subject_exact_text_search_sort_by_case_subject_criteria(
        ):
            assert True
        else:
