...
import pytest
from All_POM_Package.Identify_and_Enroll_Module.Identify_and_Enroll_POM import Identify_and_Enroll_pom
from All_Test_Cases_Package.conftest import Base_Class


class Test_identify_and_enroll(Base_Class):
    user_list = None
    results = list()
    ...
    def test_TC_IE_17(self):
        if Identify_and_Enroll_pom()\
                .verify_ranked_match_index_title_along_with_symbol_visible_on_identify_results_panel():
            assert True
        else:
    ...
    def test_TC_IE_18(self):
        if Identify_and_Enroll_pom()\
                .verify_images_are_visible_enlisted_inside_identify_result_panel():
            assert True
        else:
    ...
    def test_TC_IE_19(self):
        if Identify_and_Enroll_pom()\
                .verify_location_Case_information_and_index_score_displayed_inside_indentify_result_panel():
            assert True
        else:
    ...
    @pytest.mark.p1
    def test_TC_IE_20(self):
        if Identify_and_Enroll_pom()\
                .verify_three_buttons_faces_person_view_and_purge_Replace_are_visible():
            assert True
        else:
    ...
    def test_TC_IE_21(self):
        if Identify_and_Enroll_pom() \
                .verify_faces_button_is_visible_with_its_label_popping_up_and_clickable_on_identify_results_panel():
            assert True
        else:
    ...
    def test_TC_IE_22(self):
        if Identify_and_Enroll_pom() \
                .verify_person_view_button_is_visible_with_its_label_popping_up_and_clickable_on_identify_results_panel(
        ):
            assert True
        else:
    ...
    def test_TC_IE_23(self):
        if Identify_and_Enroll_pom() \
                .verify_purge_replace_button_is_visible_with_its_label_popping_up_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_24(self):
        if Identify_and_Enroll_pom() \
                .click_on_faces_button_and_verify_a_new_panel_with_title_enrollment_faces_is_displayed():
            assert True
        else:
    ...
    def test_TC_IE_25(self):
        if Identify_and_Enroll_pom() \
                .verify_action_dropdown_is_displayed_and_clickable_in_top_right_corner_of_enrollment_faces_panel():
            assert True
        else:
    ...
    def test_TC_IE_26(self):
        if Identify_and_Enroll_pom() \
                .click_on_action_dropdown_and_verify_menu_items_displayed_are_clickable():
            assert True
        else:
    ...
    def test_TC_IE_27(self):
        if Identify_and_Enroll_pom() \
                .verify_location_and_case_information_is_displayed_as_a_heading_inside_enrollment_faces_panel():
            assert True
        else:
    ...
    def test_TC_IE_28(self):
        if Identify_and_Enroll_pom() \
                .verify_sample_image_icon_is_visible_below_location_and_it_is_clickable():
            assert True
        else:
    ...
    def test_TC_IE_29(self):
        if Identify_and_Enroll_pom() \
                .verify_if_draggable_photo_text_is_visible_above_image_displayed():
            assert True
        else:
    ...
    def test_TC_IE_41(self):
        if Identify_and_Enroll_pom() \
                .verify_location_and_case_information_is_displayed_as_a_heading_inside_enrollment_view_panel():
            assert True
        else:
    ...
    def test_TC_IE_42(self):
        if Identify_and_Enroll_pom() \
                .verify_visitor_image_is_displayed_as_expected_below_heading_on_enrollment_view_panel():
            assert True
        else:
    ...
    def test_TC_IE_43(self):
        if Identify_and_Enroll_pom() \
                .verify_visitors_lOCATION_STORE_CASE_SUBJECT_information_is_displayed_on_enrollment_view_panel():
            assert True
        else:
    ...
    def test_TC_IE_45(self):
        if Identify_and_Enroll_pom() \
                .verify_Enrolled_On_text_and_its_information_is_visible_as_expected_on_enrollment_view_panel():
            assert True
        else:
    ...
    def test_TC_IE_46(self):
        if Identify_and_Enroll_pom()\
                .verify_enabled_disabled_information_is_visible_on_enrollment_view_panel():
            assert True
        else:
    ...
    def test_TC_IE_47(self):
        if Identify_and_Enroll_pom()\
                .verify_enrollment_details_button_is_visible_and_clickable_as_expected_on_enrollment_view_panel():
            assert True
        else:
    ...
    def test_TC_IE_48(self):
        if Identify_and_Enroll_pom()\
                .verify_faces_button_is_visible_along_with_count_and_it_is_clickable_on_enrollment_view_panel():
            assert True
        else:
    ...
    def test_TC_IE_49(self):
        if Identify_and_Enroll_pom()\
                .verify_events_button_is_visible_along_with_count_and_it_is_clickable_on_enrollment_view_panel():
            assert True
        else:
    ...
    def test_TC_IE_50(self):
        if Identify_and_Enroll_pom()\
                .verify_enrollment_groups_button_is_visible_along_with_its_count_and_is_clickable():
            assert True
        else:
    ...
    def test_TC_IE_51(self):
        if Identify_and_Enroll_pom()\
                .verify_notes_button_is_visible_along_with_its_count_and_is_clickable():
            assert True
        else:
    ...
    def test_TC_IE_52(self):
        if Identify_and_Enroll_pom() \
                .click_on_close_panel_button_displayed_beside_panel_title_and_verify_panel_is_closed_successfully():
            assert True
        else:
    ...
    def test_TC_IE_53(self):
        if Identify_and_Enroll_pom() \
                .click_on_purge_and_replace_button_and_pop_up_is_appeared_along_with_expected_message():
            assert True
        else:
    ...
    def test_TC_IE_54(self):
        if Identify_and_Enroll_pom() \
                .click_on_close_panel_button_displayed_beside_panel_title_verify_panel_closed_successfully():
            assert True
        else:
    ...
    def test_TC_IE_55(self):
        if Identify_and_Enroll_pom() \
                .click_on_Crop_Image_button_and_verify_a_pop_up_is_visible_with_expected_message():
            assert True
        else:
    ...
    def test_TC_IE_56(self):
        if Identify_and_Enroll_pom() \
                .click_on_close_panel_button_displayed_beside_panel_title_verify_panel_successfully_closed():
            assert True
        else:
    ...
    def test_TC_IE_57(self):
        if Identify_and_Enroll_pom()\
                .verify_two_new_panel_appeared_with_title_as_Enrollment_Steps_and_Add_Details():
            assert True
        else:
    ...
    def test_TC_IE_58(self):
        if Identify_and_Enroll_pom()\
                .verify_first_panel_title_Enrollment_Steps_and_below_it_image_selected_is_visible():
            assert True
        else:
    ...
    def test_TC_IE_59(self):
        if Identify_and_Enroll_pom()\
                .verify_image_properties_text_below_image_along_with_details_is_displayed_as_expected():
            assert True
        else:
    ...
    def test_TC_IE_60(self):
        if Identify_and_Enroll_pom()\
                .verify_warning_text_is_displayed_below_image_on_Enrollment_Steps_panel_as_expected():
            assert True
        else:
    ...
    def test_TC_IE_61(self):
        if Identify_and_Enroll_pom()\
                .verify_No_match_found_text_below_warning_is_visible_as_expected_on_Enrollment_Steps_panel():
            assert True
        else:
    ...
    def test_TC_IE_62(self):
        if Identify_and_Enroll_pom() \
                .verify_exposure_sharpness_resolution_images_parameters_their_data_green_tick_symbol_is_displayed():
            assert True
        else:
    ...
    def test_TC_IE_63(self):
        if Identify_and_Enroll_pom() \
                .verify_second_panel_titled_as_Add_Details_and_panel_is_active_enabled():
            assert True
        else:
    ...
    def test_TC_IE_64(self):
        if Identify_and_Enroll_pom() \
                .verify_cancel_button_below_title_Add_Details_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_65(self):
        if Identify_and_Enroll_pom() \
                .verify_save_button_below_title_Add_Details_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_66(self):
        if Identify_and_Enroll_pom() \
                .verify_two_option_Expire_Date_and_Do_Not_Expire_are_visible_and_clickable_below_Add_Details_title():
            assert True
        else:
    ...
    def test_TC_IE_67(self):
        if Identify_and_Enroll_pom() \
                .verify_date_entry_textbox_beside_Expire_Date_is_visible_and_clickable_and_current_date_is_displayed():
            assert True
        else:
    ...
    def test_TC_IE_68(self):
        if Identify_and_Enroll_pom() \
                .verify_opt_out_label_text_and_check_box_besides_is_visible_and_clickable_on_Add_Details_panel():
            assert True
        else:
    ...
    def test_TC_IE_69(self):
        if Identify_and_Enroll_pom() \
                .verify_Enrollment_Group_label_text_is_displayed_with_dropdown_beside_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_70(self):
        if Identify_and_Enroll_pom() \
                .click_on_Enrollment_Group_dropdown_and_verify_options_inside_it_are_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_71(self):
        if Identify_and_Enroll_pom() \
                .verify_Field_Incomplete_text_below_enrollment_group_dropdown_is_visible_as_expected():
            assert True
        else:
    ...
    def test_TC_IE_73(self):
        if Identify_and_Enroll_pom() \
                .verify_LOCATION_STORE_label_text_and_text_box_besides_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_74(self):
        if Identify_and_Enroll_pom() \
                .verify_Field_Incomplete_text_below_location_store_textbox_is_visible_as_expected():
            assert True
        else:
    ...
    def test_TC_IE_75(self):
        if Identify_and_Enroll_pom() \
                .verify_CASE_SUBJECT_label_text_and_text_box_besides_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_76(self):
        if Identify_and_Enroll_pom() \
                .verify_Field_Incomplete_text_below_case_subject_textbox_is_visible_as_expected():
            assert True
        else:
    ...
    def test_TC_IE_77(self):
        if Identify_and_Enroll_pom() \
                .verify_REPORTED_LOSS_label_text_and_text_box_besides_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_78(self):
        if Identify_and_Enroll_pom() \
                .verify_Field_Incomplete_text_below_REPORTED_LOSS_textbox_is_visible_as_expected():
            assert True
        else:
    ...
    def test_TC_IE_79(self):
        if Identify_and_Enroll_pom() \
                .verify_DATE_INCIDENT_label_text_and_text_box_besides_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_80(self):
        if Identify_and_Enroll_pom() \
                .verify_Field_Incomplete_text_below_DATE_INCIDENT_textbox_is_visible_as_expected():
            assert True
        else:
    ...
    def test_TC_IE_83(self):
        if Identify_and_Enroll_pom() \
                .verify_ACTION_label_text_and_text_box_besides_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_84(self):
        if Identify_and_Enroll_pom() \
                .verify_Field_Incomplete_text_below_ACTION_textbox_is_visible_as_expected():
            assert True
        else:
    ...
    def test_TC_IE_85(self):
        if Identify_and_Enroll_pom() \
                .verify_OPTIONAL_FIELDS_heading_below_action_textbox_is_displayed():
            assert True
        else:
    ...
    def test_TC_IE_86(self):
        if Identify_and_Enroll_pom() \
                .verify_CASE_EVENT_TYPE_label_text_is_displayed_with_dropdown_beside_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_87(self):
        if Identify_and_Enroll_pom() \
                .click_on_CASE_EVENT_TYPE_dropdown_and_verify_options_inside_it_are_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_88(self):
        if Identify_and_Enroll_pom() \
                .verify_ACTIVITY_TYPE_label_text_is_displayed_with_dropdown_beside_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_89(self):
        if Identify_and_Enroll_pom() \
                .click_on_ACTIVITY_TYPE_dropdown_and_verify_options_inside_it_are_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_90(self):
        if Identify_and_Enroll_pom() \
                .verify_METHOD_OF_OFFENSE_label_text_is_displayed_with_dropdown_beside_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_91(self):
        if Identify_and_Enroll_pom() \
                .click_on_METHOD_OF_OFFENSE_dropdown_and_verify_options_inside_it_are_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_92(self):
        if Identify_and_Enroll_pom() \
                .verify_REPORTED_BY_label_text_and_text_box_besides_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_93(self):
        if Identify_and_Enroll_pom() \
                .verify_Build_label_text_and_text_box_besides_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_94(self):
        if Identify_and_Enroll_pom() \
                .verify_Body_Markings_label_text_and_text_box_besides_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_95(self):
        if Identify_and_Enroll_pom() \
                .verify_GENDER_label_text_is_displayed_with_dropdown_beside_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_96(self):
        if Identify_and_Enroll_pom() \
                .click_on_GENDER_dropdown_and_verify_options_inside_it_are_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_97(self):
        if Identify_and_Enroll_pom() \
                .verify_HEIGHT_label_text_is_displayed_with_dropdown_beside_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_98(self):
        if Identify_and_Enroll_pom() \
                .click_on_HEIGHT_dropdown_and_verify_options_inside_it_are_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_99(self):
        if Identify_and_Enroll_pom() \
                .verify_NARRATIVES_label_text_and_text_box_besides_it_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_100(self):
        if Identify_and_Enroll_pom() \
                .Enter_Data_into_fields_displayed_on_Add_Details_panel_and_verify_enrollment_successfully_created():
            assert True
        else:
    ...
    def test_TC_IE_101(self):
        if Identify_and_Enroll_pom() \
                .verify_Success_message_is_displayed_below_warning_on_Identify_and_enroll_panel():
            assert True
        else:
    ...
    def test_TC_IE_102(self):
        if Identify_and_Enroll_pom() \
                .verify_three_buttons_below_success_message_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_103(self):
        if Identify_and_Enroll_pom() \
                .click_on_Review_Enrollment_Details_button_and_verify_if_Enrollment_Details_panel_is_displayed():
            assert True
        else:
    ...
    def test_TC_IE_104(self):
        if Identify_and_Enroll_pom() \
                .verify_Action_button_visible_and_clickable_on_Enrollment_Details_Panel_below_its_title():
            assert True
        else:
    ...
    def test_TC_IE_105(self):
        if Identify_and_Enroll_pom() \
             .click_and_verify_Edit_Identify_Within_Enrollment_and_Identify_within_visitors_option_are_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_106(self):
        if Identify_and_Enroll_pom() \
             .verify_location_and_case_name_is_displayed_as_heading_on_Enrollment_Details_panel():
            assert True
        else:
    ...
    def test_TC_IE_107(self):
        if Identify_and_Enroll_pom() \
             .verify_visitor_image_is_visible_besides_it_Enrolled_on_date_and_time_is_displayed_as_expected():
            assert True
        else:
    ...
    def test_TC_IE_108(self):
        if Identify_and_Enroll_pom() \
             .verify_Enabled_Disabled_status_with_its_symbol_is_visible_besides_visitor_image():
            assert True
        else:
    ...
    def test_TC_IE_109(self):
        if Identify_and_Enroll_pom() \
             .verify_Opt_out_status_is_displayed_as_expected_on_Enrollment_Details_panel():
            assert True
        else:
    ...
    def test_TC_IE_110(self):
        if Identify_and_Enroll_pom() \
             .verify_REQUIRED_FIELDS_heading_is_displayed_along_with_its_data_on_Enrollment_Details_Panel():
            assert True
        else:
    ...
    def test_TC_IE_111(self):
        if Identify_and_Enroll_pom() \
             .verify_OPTIONAL_FIELDS_heading_below_required_field_is_displayed_as_expected():
            assert True
        else:
    ...
    def test_TC_IE_112(self):
        if Identify_and_Enroll_pom() \
             .click_on_close_enrollment_details_panel_and_verify_panel_is_closed_successfully():
            assert True
        else:
    ...
    def test_TC_IE_113(self):
        if Identify_and_Enroll_pom() \
             .click_on_Review_Added_Groups_Button_and_verify_if_enrollment_groups_panel_is_visible():
            assert True
        else:
    ...
    def test_TC_IE_114(self):
        if Identify_and_Enroll_pom() \
             .verify_Filter_dropdown_is_visible_and_clickable_on_Enrollment_Groups_Panel():
            assert True
        else:
    ...
    def test_TC_IE_115(self):
        if Identify_and_Enroll_pom() \
             .click_on_Filter_dropdown_and_verify_its_options_are_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_116(self):
        if Identify_and_Enroll_pom() \
             .verify_Action_dropdown_is_visible_and_clickable_on_Enrollment_Groups_Panel():
            assert True
        else:
    ...
    def test_TC_IE_117(self):
        if Identify_and_Enroll_pom() \
                .click_on_Action_dropdown_and_verify_its_options_are_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_118(self):
        if Identify_and_Enroll_pom() \
                        .verify_select_all_check_box_along_with_its_label_is_visible_and_clickable():
            assert True
        else:
    ...
    def test_TC_IE_119(self):
        if Identify_and_Enroll_pom() \
                    .verify_enrollment_groups_associated_with_enrollment_is_enlisted_inside_Enrollment_Groups_panel():
            assert True
        else:
    ...
    def test_TC_IE_120(self):
        if Identify_and_Enroll_pom() \
                        .click_on_close_enrollment_group_panel_and_verify_panel_is_closed_successfully():
            assert True
        else:
    ...
    def test_TC_IE_121(self):
        if Identify_and_Enroll_pom() \
                        .click_on_add_more_faces_button_and_verify_if_Enrollment_Faces_panel_is_displayed():
            assert True
        else:
    ...
    def test_TC_IE_122(self):
        if Identify_and_Enroll_pom() \
                        .verify_Action_button_is_visible_and_clickable_on_Enrollment_Faces_Panel_below_its_title():
            assert True
        else:
    ...
    def test_TC_IE_123(self):
        if Identify_and_Enroll_pom() \
                        .click_on_Action_dropdown_and_verify_its_options_are_visible_and_clickable_enroll_face_panel():
            assert True
        else:
    ...
    def test_TC_IE_124(self):
        if Identify_and_Enroll_pom() \
                        .verify_location_and_case_name_is_displayed_as_heading_on_Enrollment_Faces_panel():
            assert True
        else:
    ...
    def test_TC_IE_125(self):
        if Identify_and_Enroll_pom() \
                        .verify_sample_image_box_is_visible_and_clickable_below_location_information():
            assert True
        else:
    ...
    def test_TC_IE_126(self):
        if Identify_and_Enroll_pom() \
                        .click_on_sample_image_box_and_verify_if_file_open_dialog_box_is_displayed():
            assert True
        else:
    ...
    def test_TC_IE_127(self):
        if Identify_and_Enroll_pom() \
                        .verify_Dragable_Photo_Text_be_displayed_on_enrolled_visitor_image_below_sample_image():
            assert True
        else:
    ...
    def test_TC_IE_128(self):
        if Identify_and_Enroll_pom() \
                        .verify_check_box_is_visible_and_clickable_besides_visitor_image_on_the_panel():
            assert True
        else:
    ...
    def test_TC_IE_129(self):
        if Identify_and_Enroll_pom() \
                        .verify_download_image_button_is_visible_and_clickable_besides_visitor_image():
            assert True
        else:
    ...
    def test_TC_IE_130(self):
        if Identify_and_Enroll_pom() \
                        .verify_image_file_info_button_is_visible_and_clickable_besides_visitor_image():
            assert True
        else:
    ...
    def test_TC_IE_131(self):
        if Identify_and_Enroll_pom() \
                        .click_on_download_image_button_and_verify_image_is_downloaded_successfully():
            assert True
        else:
    ...
    def test_TC_IE_132(self):
        if Identify_and_Enroll_pom() \
                        .click_on_image_file_info_button_and_verify_a_pop_up_is_displayed_with_image_information():
            assert True
        else:
    ...
    def test_TC_IE_133(self):
        if Identify_and_Enroll_pom() \
                .click_on_close_panel_button_and_verify_enrollment_faces_panel_is_closed_successfully():
            assert True
        else:
