...
class Read_Identify_and_Enroll_Components:
    ...
    def identify_and_enroll_panel_title(self):
        try:
            identify_and_enroll_panel_title = self.config.get("VALIDATION", "identify_and_enroll_panel_title")
    ...
    def identify_and_enroll_panel_select_photo_text(self):
        try:
            identify_and_enroll_panel_select_photo_text = self.config.get("VALIDATION",
    ...
    def select_Photo_Instructions_text(self):
        try:
            select_Photo_Instructions_text = self.config.get("VALIDATION",
    ...
    def image_properties_text(self):
        try:
            image_properties_text = self.config.get("VALIDATION", "image_properties_text")
    ...
    def identify_enroll_panel_text_validation(self):
        try:
            identify_enroll_txt = self.config.get("VALIDATION", "identify_enroll_panel_text_validation")
            return identify_enroll_txt
        except Exception as ex:
    ...
    def select_photo_instructions_text_validation(self):
        try:
            data = self.config.get("VALIDATION", "select_photo_instructions_text_validation")
            return data
        except Exception as ex:
    ...
    def identify_results_text_validation(self):
        try:
            data = self.config.get("VALIDATION", "identify_results_text_validation")
            return data
        except Exception as ex:
    ...
    def download_button_validation(self):
        try:
            download_button_validation = self.config.get("VALIDATION", "download_button_validation")
    ...
    def identify_results_person_view_icon_hover_text_validation(self):
        try:
            person_view_hover = self.config.get("VALIDATION", "identify_results_person_view_icon_hover_text_validation")
            return person_view_hover
        except Exception as ex:
    ...
    def identify_results_purge_replace_icon_hover_text_validation(self):
        try:
            person_view_hover = self.config \
                .get("VALIDATION", "identify_results_purge_replace_icon_hover_text_validation")
            return person_view_hover
        except Exception as ex:
    ...
    def enrollment_faces_text_validation(self):
        try:
            txt = self.config.get("VALIDATION", "enrollment_faces_text_validation")
            return txt
        except Exception as ex:
    ...
    def enrollment_faces_drop_down_identify_within_enrollments_txt_validation(self):
        try:
            txt = self.config.get("VALIDATION", "enrollment_faces_drop_down_identify_within_enrollments_txt_validation")
            return txt
        except Exception as ex:
    ...
    def enrollment_faces_drop_down_identify_within_visitors_txt_validation(self):
        try:
            txt = self.config.get("VALIDATION", "enrollment_faces_drop_down_identify_within_visitors_txt_validation")
            return txt
        except Exception as ex:
    ...
    def enrollment_faces_drop_down_add_photo_txt_validation(self):
        try:
            txt = self.config.get("VALIDATION", "enrollment_faces_drop_down_add_photo_txt_validation")
            return txt
        except Exception as ex:
    ...
    def enrollment_faces_drop_down_delete_selected_faces_txt_validation(self):
        try:
            txt = self.config.get("VALIDATION", "enrollment_faces_drop_down_delete_selected_faces_txt_validation")
            return txt
        except Exception as ex:
    ...
    def enrollment_faces_draggable_photo_txt_validation(self):
        try:
            ele = self.config.get("VALIDATION", "enrollment_faces_draggable_photo_txt_validation")
            return ele
        except Exception as ex:
    ...
    def identify_results_ranked_match_index_text_validation(self):
        try:
            txt = self.config.get("VALIDATION", "identify_results_ranked_match_index_text_validation")
            return txt
        except Exception as ex:
    ...
    def identify_results_face_icon_hover_text_validation(self):
        try:
            face_icon_hover_txt = self.config.get("VALIDATION", "identify_results_face_icon_hover_text_validation")
    ...
    def view_image_file_info(self):
        try:
            view_image_file_info = self.config.get("VALIDATION", "view_image_file_info")
    ...
    def view_image_pop_up_text_1(self):
        try:
            view_image_pop_up_text_1 = self.config.get("VALIDATION", "view_image_pop_up_text_1")
    ...
    def view_image_pop_up_text_2(self):
        try:
            view_image_pop_up_text_2 = self.config.get("VALIDATION", "view_image_pop_up_text_2")
    ...
    def view_image_pop_up_text_3(self):
        try:
            view_image_pop_up_text_3 = self.config.get("VALIDATION", "view_image_pop_up_text_3")
    ...
    def view_image_pop_up_text_4(self):
        try:
            view_image_pop_up_text_4 = self.config.get("VALIDATION", "view_image_pop_up_text_4")
    ...
    def disable_enrollment_option_validation(self):
        try:
            ele = self.config.get("VALIDATION", "disable_enrollment_option")
            return ele
        except Exception as ex:
    ...
    def identify_within_enrollments_option_validation(self):
        try:
            ele = self.config.get("VALIDATION", "identify_within_enrollments_option")
            return ele
        except Exception as ex:
    ...
    def identify_within_visitors_option_validation(self):
        try:
            ele = self.config.get("VALIDATION", "identify_within_visitors_option")
            return ele
        except Exception as ex:
    ...
    def view_edit_details_option_validation(self):
        try:
            ele = self.config.get("VALIDATION", "view_edit_details_option")
            return ele
        except Exception as ex:
    ...
    def delete_enrollment_option_validation(self):
        try:
            ele = self.config.get("VALIDATION", "delete_enrollment_option")
            return ele
        except Exception as ex:
    ...
    def identify_within_enrollments_option(self):
        try:
            ele = self.config.get("LOCATORS", "identify_within_enrollments_option")
            return ele
        except Exception as ex:
    ...
    def disable_enrollment_option_click_validation(self):
        try:
            ele = self.config.get("VALIDATION", "disable_enrollment_option_click_validation")
            return ele
        except Exception as ex:
    ...
    def identify_result_text_validation(self):
        try:
            ele = self.config.get("VALIDATION", "identify_result_text_validation")
            return ele
        except Exception as ex:
    ...
    def enrollment_view_enrollment_details_txt_validation(self):
        try:
            data = self.config.get("VALIDATION", "enrollment_view_enrollment_details_txt_validation")
            return data
        except Exception as ex:
    ...
    def enrollment_view_faces_txt_validation(self):
        try:
            data = self.config.get("VALIDATION", "enrollment_view_faces_txt_validation")
            return data
        except Exception as ex:
    ...
    def enrollment_view_events_txt_validation(self):
        try:
            data = self.config.get("VALIDATION", "enrollment_view_events_txt_validation")
            return data
        except Exception as ex:
    ...
    def enrollment_view_enrollment_groups_txt_validation(self):
        try:
            data = self.config.get("VALIDATION", "enrollment_view_enrollment_groups_txt_validation")
            return data
        except Exception as ex:
    ...
    def enrollment_view_notes_txt_validation(self):
        try:
            data = self.config.get("VALIDATION", "enrollment_view_notes_txt_validation")
            return data
        except Exception as ex:
    ...
    def enrollment_view_panel_title_validation(self):
        try:
            data = self.config.get("VALIDATION", "enrollment_view_panel_title_validation")
            return data
        except Exception as ex:
    ...
    def purge_and_replace_validation_text(self):
        try:
            data = self.config.get("VALIDATION", "purge_and_replace_validation_text")
            return data
        except Exception as ex:
    ...
    def crop_photo_validation(self):
        try:
            data = self.config.get("VALIDATION", "crop_photo_validation")
            return data
        except Exception as ex:
    ...
    def enrollment_steps_title_txt_validation(self):
        try:
            data = self.config.get("VALIDATION", "enrollment_steps_title_txt_validation")
            return data
        except Exception as ex:
    ...
    def add_details_panel_title_txt_validation(self):
        try:
            data = self.config.get("VALIDATION", "add_details_panel_title_txt_validation")
            return data
        except Exception as ex:
    ...
    def enrollment_steps_image_properties_txt_validation(self):
        try:
            data = self.config.get("VALIDATION", "enrollment_steps_image_properties_txt_validation")
            return data
        except Exception as ex:
    ...
    def enrollment_steps_warning_txt_validation(self):
        try:
            data = self.config.get("VALIDATION", "enrollment_steps_warning_txt_validation")
            return data
        except Exception as ex:
    ...
    def enrollment_steps_no_match_found_txt_validation(self):
        try:
            data = self.config.get("VALIDATION", "enrollment_steps_no_match_found_txt_validation")
            return data
        except Exception as ex:
    ...
    def add_details_cancel_msg_txt_validation(self):
        try:
            add_details_cancel_msg_txt_validation = self.config \
                .get("VALIDATION", "add_details_cancel_msg_txt_validation")
    ...
    def location_store_data(self):
        try:
            location_store_data = self.config \
                .get("DATA", "location_store_data")
    ...
    def case_subject_data(self):
        try:
            case_subject_data = self.config \
                .get("DATA", "case_subject_data")
    ...
    def reported_loss_data(self):
        try:
            reported_loss_data = self.config \
                .get("DATA", "reported_loss_data")
    ...
    def date_incident_data(self):
        try:
            date_incident_data = self.config \
                .get("DATA", "date_incident_data")
    ...
    def action_input_data(self):
        try:
            action_input_data = self.config \
                .get("DATA", "action_input_data")
    ...
    def enrollment_success_msg_validation(self):
        try:
            enrollment_success_msg_validation = self.config \
                .get("VALIDATION", "enrollment_success_msg_validation")
    ...
    def opt_out_txt_validation(self):
        try:
            opt_out_txt_validation = self.config \
                .get("VALIDATION", "opt_out_txt_validation")
    ...
    def add_details_location_store_txt_validation(self):
        try:
            add_details_location_store_txt_validation = self.config \
                .get("VALIDATION", "add_details_location_store_txt_validation")
    ...
    def add_details_location_store_data_input(self):
        try:
            add_details_location_store_data_input = self.config \
                .get("DATA", "add_details_location_store_data_input")
    ...
    def add_details_case_subject_txt_validation(self):
        try:
            add_details_case_subject_txt_validation = self.config \
                .get("VALIDATION", "add_details_case_subject_txt_validation")
    ...
    def add_details_case_subject_data_input(self):
        try:
            add_details_case_subject_data_input = self.config \
                .get("DATA", "add_details_case_subject_data_input")
    ...
    def add_details_reported_loss_data_input(self):
        try:
            add_details_reported_loss_data_input = self.config \
                .get("DATA", "add_details_reported_loss_data_input")
    ...
    def add_details_reported_loss_txt_validation(self):
        try:
            add_details_reported_loss_txt_validation = self.config \
                .get("VALIDATION", "add_details_reported_loss_txt_validation")
    ...
    def add_details_action_data_input(self):
        try:
            add_details_action_data_input = self.config \
                .get("DATA", "add_details_action_data_input")
    ...
    def reported_by_data(self):
        try:
            reported_by_data = self.config\
                .get("DATA", "reported_by_data")
    ...
    def body_markings_data(self):
        try:
            body_markings_data = self.config\
                .get("DATA", "body_markings_data")
    ...
    def narratives_data(self):
        try:
            narratives_data = self.config\
                .get("DATA", "narratives_data")
    ...
    def enrollment_details_panel_close_validation(self):
        try:
            ele = self.config.get("VALIDATION", "enrollment_details_panel_close")
            return ele
        except Exception as ex:
            print("enrollment_details_panel_close : ", ex)
    ...
    def enrollment_faces_panel_close(self):
        try:
            ele = self.config.get("VALIDATION", "enrollment_faces_panel_close")
            return ele
        except Exception as ex:
    ...
    def identify_enroll_btn_below_text(self):
        try:
            ele = self.config.get("VALIDATION", "identify_enroll_btn_below_text")
            return ele
        except Exception as ex:
    ...
    def reselect_photo_btn_below_text(self):
        try:
            ele = self.config.get("VALIDATION", "reselect_photo_btn_below_text")
            return ele
        except Exception as ex:
    ...
    def crop_photo_btn_below_text(self):
        try:
            ele = self.config.get("VALIDATION", "crop_photo_btn_below_text")
            return ele
        except Exception as ex:
