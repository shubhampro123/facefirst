...
class Read_Visitor_Search_Components:
    ...
    def meta_data_without_date_validation_msg(self):
        try:
            ele = self.config.get("VALIDATION", "meta_data_without_date_validation_msg")
            return ele
        except Exception as ex:
    ...
    def limited_to_30_meta_data_search_validation(self):
        try:
            ele = self.config.get("VALIDATION", "limited_to_30_meta_data_search_validation")
            return ele
        except Exception as ex:
    ...
    def meta_data_start_date(self):
        try:
            ele = self.config.get("DATA", "meta_data_start_date")
            return ele
        except Exception as ex:
    ...
    def meta_data_start_month(self):
        try:
            ele = self.config.get("DATA", "meta_data_start_month")
            return ele
        except Exception as ex:
    ...
    def meta_data_start_year(self):
        try:
            ele = self.config.get("DATA", "meta_data_start_year")
            return ele
        except Exception as ex:
    ...
    def meta_data_start_hour(self):
        try:
            ele = self.config.get("DATA", "meta_data_start_hour")
            return ele
        except Exception as ex:
    ...
    def meta_data_start_minuet(self):
        try:
            ele = self.config.get("DATA", "meta_data_start_minuet")
            return ele
        except Exception as ex:
    ...
    def meta_data_start_am_pm_period(self):
        try:
            ele = self.config.get("DATA", "meta_data_start_am_pm_period")
            return ele
        except Exception as ex:
    ...
    def meta_data_end_date(self):
        try:
            ele = self.config.get("DATA", "meta_data_end_date")
            return ele
        except Exception as ex:
    ...
    def meta_data_end_month(self):
        try:
            ele = self.config.get("DATA", "meta_data_end_month")
            return ele
        except Exception as ex:
    ...
    def meta_data_end_year(self):
        try:
            ele = self.config.get("DATA", "meta_data_end_year")
            return ele
        except Exception as ex:
    ...
    def meta_data_end_hour(self):
        try:
            ele = self.config.get("DATA", "meta_data_end_hour")
            return ele
        except Exception as ex:
    ...
    def meta_data_end_minuet(self):
        try:
            ele = self.config.get("DATA", "meta_data_end_minuet")
            return ele
        except Exception as ex:
    ...
    def meta_data_end_am_pm_period(self):
        try:
            ele = self.config.get("DATA", "meta_data_end_am_pm_period")
            return ele
        except Exception as ex:
