...
class Read_Enrollments_Components:
    ...
    def enroll_get_start_date(self):
        try:
            enroll_get_start_date = self.config.get("DATA", "enroll_start_date")
    ...
    def enroll_get_start_month(self):
        try:
            enroll_get_start_month = self.config.get("DATA", "enroll_start_month")
    ...
    def enroll_get_start_year(self):
        try:
            enroll_get_start_year = self.config.get("DATA", "enroll_start_year")
    ...
    def enroll_get_start_hour(self):
        try:
            enroll_get_start_hour = self.config.get("DATA", "enroll_start_hour")
    ...
    def enroll_get_start_minuet(self):
        try:
            enroll_get_start_minuet = self.config.get("DATA", "enroll_start_minuet")
    ...
    def enroll_get_start_am_pm_period(self):
        try:
            enroll_get_start_am_pm_period = self.config.get("DATA", "enroll_start_am_pm_period")
    ...
    def enroll_get_end_date(self):
        try:
            enroll_get_end_date = self.config.get("DATA", "enroll_end_date")
    ...
    def enroll_get_end_month(self):
        try:
            enroll_get_end_month = self.config.get("DATA", "enroll_end_month")
    ...
    def enroll_get_end_year(self):
        try:
            enroll_get_end_year = self.config.get("DATA", "enroll_end_year")
    ...
    def enroll_get_end_hour(self):
        try:
            enroll_get_end_hour = self.config.get("DATA", "enroll_end_hour")
    ...
    def enroll_get_end_minuet(self):
        try:
            enroll_get_end_minuet = self.config.get("DATA", "enroll_end_minuet")
    ...
    def enroll_get_end_am_pm_period(self):
        try:
            enroll_get_end_am_pm_period = self.config.get("DATA", "enroll_end_am_pm_period")
    ...
    def expiration_get_start_date(self):
        try:
            expiration_get_start_date = self.config.get("DATA", "expiration_start_date")
    ...
    def expiration_get_start_month(self):
        try:
            expiration_get_start_month = self.config.get("DATA", "expiration_start_month")
    ...
    def expiration_get_start_year(self):
        try:
            expiration_get_start_year = self.config.get("DATA", "expiration_start_year")
    ...
    def expiration_get_start_hour(self):
        try:
            expiration_get_start_hour = self.config.get("DATA", "expiration_start_hour")
    ...
    def expiration_get_start_minuet(self):
        try:
            expiration_get_start_minuet = self.config.get("DATA", "expiration_start_minuet")
    ...
    def expiration_get_start_am_pm_period(self):
        try:
            expiration_get_start_am_pm_period = self.config.get("DATA", "expiration_start_am_pm_period")
    ...
    def expiration_get_end_date(self):
        try:
            expiration_get_end_date = self.config.get("DATA", "expiration_end_date")
    ...
    def expiration_get_end_month(self):
        try:
            expiration_get_end_month = self.config.get("DATA", "expiration_end_month")
    ...
    def expiration_get_end_year(self):
        try:
            expiration_get_end_year = self.config.get("DATA", "expiration_end_year")
    ...
    def expiration_get_end_hour(self):
        try:
            expiration_get_end_hour = self.config.get("DATA", "expiration_end_hour")
    ...
    def expiration_get_end_minuet(self):
        try:
            expiration_get_end_minuet = self.config.get("DATA", "expiration_end_minuet")
    ...
    def expiration_get_end_am_pm_period(self):
        try:
            expiration_get_end_am_pm_period = self.config.get("DATA", "expiration_end_am_pm_period")
    ...
    def location_store_data_input(self):
        try:
            location_store_data_input = self.config.get("DATA", "location_store_data_input")
    ...
    def case_subject_data_input(self):
        try:
            case_subject_data_input = self.config.get("DATA", "case_subject_data_input")
    ...
    def sort_by_data_input_LOCATION_STORE(self):
        try:
            sort_by_data_input = self.config.get("DATA", "sort_by_data_input_LOCATION_STORE")
    ...
    def sort_by_data_input_Enrolled_On(self):
        try:
            sort_by_data_input = self.config.get("DATA", "sort_by_data_input_Enrolled_On")
            return sort_by_data_input
        except Exception as ex:
    ...
    def sort_by_data_input_CASE_SUBJECT(self):
        try:
            sort_by_data_input = self.config.get("DATA", "sort_by_data_input_CASE_SUBJECT")
            return sort_by_data_input
        except Exception as ex:
